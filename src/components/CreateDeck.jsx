...
export default function CreateDeck() {
  ...
  return (
    <div className="max-w-3xl mx-auto bg-white p-8 shadow rounded-lg">
      <h2 className="text-2xl font-semibold mb-4">Create Sales Deck</h2>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <div className="max-h-40 overflow-y-auto border border-gray-200 rounded-lg p-2">{files.length === 0 && <p className="text-gray-500">No files uploaded.</p>}
            {files.map((file, idx) => (
